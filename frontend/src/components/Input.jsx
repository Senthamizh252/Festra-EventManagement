        ...
        <div className="flex flex-col gap-2 w-full">
            ...
            <div className="relative rounded-xl shadow-2xs">
                ...
                <input
                    ...
                    disabled={disabled}
                    required={required}
                    className={`block w-full py-3.5 ${Icon ? 'pl-11' : 'pl-4.5'
                        } pr-4.5 bg-slate-50/50 focus:bg-white border rounded-xl text-sm sm:text-[15.5px] text-festra-text-primary placeholder:text-gray-450/90 focus:outline-none focus:ring-2 transition-all duration-200 ${error
